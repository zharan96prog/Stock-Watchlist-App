import { getPopularSymbols } from '../../config/fmpFreeSymbols';
      ...
      <div className="flex">
        ...
        <div className="ml-3">
          ...
          <div className="mt-2 text-sm text-yellow-700">
            <p>
              На безкоштовному плані доступні тільки найпопулярніші компанії
              (близько 80 символів). Спробуйте пошукати:
            </p>
